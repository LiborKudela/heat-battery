...
class HallC3(Term):
    ...
    def define_terms(self):
        ...
        self.Q_m_update = self.update_from_form_integral('THT_surface')
    ...
    def alpha_m_update(self, t):
        ...
        m_area = self.sim.get_surface_area('THT_surface')
...
class C3_passive(Simulation):
    def define_form_subdomain_terms(self):
        ...
        self.set_bc_term(hr_obj, "THT_surface")
    ...
    def create_common_probes(self, probes: Probe_writer):
        ...
        area_surf = self.get_surface_area('THT_surface')
        Tmean_m_surf = fem.form(self.T/area_surf*self.jac*self.get_measure_ds('THT_surface'))
